...
namespace mml {
  ...
  ////////////////////////////////////////////////////////////
  cursor::cursor() : _impl(new priv::cursor_impl()) {
    // That's it
  }

  ////////////////////////////////////////////////////////////
  cursor::~cursor() { delete _impl; }

  ////////////////////////////////////////////////////////////
  bool cursor::load_from_pixels(
  ...
  ////////////////////////////////////////////////////////////
  bool cursor::load_from_system(type t) { return _impl->load_from_system(t); }

  ////////////////////////////////////////////////////////////
  const priv::cursor_impl& cursor::get_impl() const { return *_impl; }
