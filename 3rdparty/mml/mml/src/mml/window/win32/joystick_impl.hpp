...
namespace mml {
  namespace priv {
    ...
    private:
      ...
      device_enumeration_callback(const DIDEVICEINSTANCE* deviceInstance, void* userData);
      ...
      ///
      ////////////////////////////////////////////////////////////
      static BOOL CALLBACK device_object_enumeration_callback(
      ...
      int m_axes[joystick::axis_count];  ///< Offsets to the bytes containing the axes states, -1 if
                                         ///< not available
      int m_buttons[joystick::button_count];      ///< Offsets to the bytes containing the button
                                                  ///< states, -1 if not available
