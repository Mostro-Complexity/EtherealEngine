...
namespace mml {
  namespace priv {
    ...
    private:
      ...
      global_on_event(HWND handle, UINT message, WPARAM wParam, LPARAM lParam);
      ...
      ///< Last cursor used -- this data is not owned by the window and is required to be always
      ///< valid
      ...
      bool _resizing;
      ///< First half of the surrogate pair, in case we're receiving a Unicode character in two
      ///< events
