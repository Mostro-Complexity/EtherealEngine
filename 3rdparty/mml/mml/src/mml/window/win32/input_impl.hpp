...
namespace mml {
  namespace priv {
    ...
    public:
      ...
      ////////////////////////////////////////////////////////////
      static void
      set_mouse_position(const std::array<std::int32_t, 2>& position, const window& relativeTo);
      ...
      ///
      ////////////////////////////////////////////////////////////
      static std::array<std::int32_t, 2>
      get_touch_position(unsigned int finger, const window& relativeTo);
    };
