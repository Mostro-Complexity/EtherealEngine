...
namespace mml {
  ////////////////////////////////////////////////////////////
  video_mode::video_mode() : width(0), height(0), bits_per_pixel(0) {}

  ////////////////////////////////////////////////////////////
  video_mode::video_mode(
    unsigned int modeWidth, unsigned int modeHeight, unsigned int modeBitsPerPixel)
    : width(modeWidth), height(modeHeight), bits_per_pixel(modeBitsPerPixel) {}
  ...
  ////////////////////////////////////////////////////////////
  bool operator!=(const video_mode& left, const video_mode& right) { return !(left == right); }
  ...
  ////////////////////////////////////////////////////////////
  bool operator>(const video_mode& left, const video_mode& right) { return right < left; }
