...
namespace mml {
  namespace priv {
    ...
    joystick_manager::get_identification(unsigned int joystick) const {
    ...
    ////////////////////////////////////////////////////////////
    joystick_manager::joystick_manager() { joystick_impl::initialize(); }

    ////////////////////////////////////////////////////////////
    joystick_manager::~joystick_manager() {
      for (int i = 0; i < joystick::count; ++i) {
        if (m_joysticks[i].state.connected) m_joysticks[i].joystick.close();
      }
