...
namespace mml {
  namespace priv {
    ...
    ////////////////////////////////////////////////////////////
    cursor_impl::cursor_impl() : _display(open_display()), _cursor(None) {
      // That's it.
    }
    ...
    ////////////////////////////////////////////////////////////
    bool cursor_impl::load_from_pixels(
      ...
      Pixmap maskPixmap = XCreateBitmapFromData(
        _display, XDefaultRootWindow(_display), (char*) &mask[0], size[0], size[1]);
      Pixmap dataPixmap = XCreateBitmapFromData(
        _display, XDefaultRootWindow(_display), (char*) &data[0], size[0], size[1]);
      ...
      _cursor =
        XCreatePixmapCursor(_display, dataPixmap, maskPixmap, &fg, &bg, hotspot[0], hotspot[1]);
