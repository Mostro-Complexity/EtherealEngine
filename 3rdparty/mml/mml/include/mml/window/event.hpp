...
namespace mml {
  ...
  public:
    ...
    union {
      ...
      ///< mouse button event parameters (platform_event::mouse_button_pressed,
      ///< platform_event::mouse_button_released)
      ...
      ///< joystick button event parameters (platform_event::joystick_button_pressed,
      ///< platform_event::joystick_button_released)
      joystick_button_event joystick_button;

      ///< joystick (dis)connect event parameters (platform_event::joystick_connected,
      ///< platform_event::joystick_disconnected)
      joystick_connect_event joystick_connect;

      ///< touch events parameters (platform_event::touch_began, platform_event::touch_moved,
      ///< platform_event::touch_ended)
      touch_event touch;
...
///     if ((event.type == mml::platform_event::key_pressed) && (event.key.code ==
///     mml::keyboard::Escape))
