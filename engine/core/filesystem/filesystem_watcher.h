...
namespace fs {
  ...
  protected:
    ...
    /// </summary>
    //-----------------------------------------------------------------------------
    static std::uint64_t watch_impl(
      const fs::path& path, bool recursive, bool initialList, clock_t::duration poll_interval,
      notify_callback& listCallback);
