...
namespace nonstd {
  template <typename T> struct null_popper { void operator()(T&) const noexcept; };

  template <typename T> struct default_popper { T operator()(T& t) const; };
  ...
  template <typename T, class Popper = default_popper<T>> class ring_span {
  public:
    ...
    template <class ContiguousIterator>
    ring_span(
      ContiguousIterator begin, ContiguousIterator end, ContiguousIterator first, size_type size,
    ...
    void
    push_back(const value_type& from_value) noexcept(std::is_nothrow_copy_assignable<T>::value);
  ...
  public:
    ...
    template <bool C> bool operator==(const ring_iterator<Ring, C>& rhs) const noexcept;
    template <bool C> bool operator!=(const ring_iterator<Ring, C>& rhs) const noexcept;
    template <bool C> bool operator<(const ring_iterator<Ring, C>& rhs) const noexcept;
    template <bool C> bool operator<=(const ring_iterator<Ring, C>& rhs) const noexcept;
    template <bool C> bool operator>(const ring_iterator<Ring, C>& rhs) const noexcept;
    ...
    template <bool C> std::ptrdiff_t operator-(const ring_iterator<Ring, C>& rhs) const noexcept;
...
template <typename T> void nonstd::null_popper<T>::operator()(T&) const noexcept {}

template <typename T> T nonstd::default_popper<T>::operator()(T& t) const { return std::move(t); }

template <typename T> nonstd::copy_popper<T>::copy_popper(T t) : m_copy(std::move(t)) {}

template <typename T> T nonstd::copy_popper<T>::operator()(T& t) const {
  T old = m_copy;
  using std::swap;
  swap(old, t);
  return old;
...
template <typename T, class Popper>
template <class ContiguousIterator>
nonstd::ring_span<T, Popper>::ring_span(
  ContiguousIterator begin, ContiguousIterator end, Popper p) noexcept
  : m_data(&*begin), m_capacity(end - begin), m_popper(std::move(p)) {}
...
nonstd::ring_span<T, Popper>::ring_span(
  ContiguousIterator begin, ContiguousIterator end, ContiguousIterator first, size_type size,
  Popper p) noexcept
  : m_data(&*begin), m_size(size), m_capacity(end - begin), m_front_idx(first - begin),
    m_popper(std::move(p)) {}

template <typename T, class Popper> bool nonstd::ring_span<T, Popper>::empty() const noexcept {
  return m_size == 0;
}

template <typename T, class Popper> bool nonstd::ring_span<T, Popper>::full() const noexcept {
  return m_size == m_capacity;
}

template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::size_type
nonstd::ring_span<T, Popper>::size() const noexcept {
  return m_size;
}

template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::size_type
nonstd::ring_span<T, Popper>::capacity() const noexcept {
  return m_capacity;
}
...
template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::const_reference
nonstd::ring_span<T, Popper>::front() const noexcept {
  return *begin();
}

template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::const_reference
nonstd::ring_span<T, Popper>::back() const noexcept {
  return *(--end());
}
...
template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::const_iterator
nonstd::ring_span<T, Popper>::begin() const noexcept {
...
template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::const_iterator
nonstd::ring_span<T, Popper>::end() const noexcept {
  return const_iterator(size() + m_front_idx, this);
}

template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::const_iterator
nonstd::ring_span<T, Popper>::cbegin() const noexcept {
  return begin();
}

template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::reverse_iterator
nonstd::ring_span<T, Popper>::rbegin() noexcept {
  return reverse_iterator(end());
}

template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::const_reverse_iterator
nonstd::ring_span<T, Popper>::rbegin() const noexcept {
  return const_reverse_iterator(end());
}

template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::const_reverse_iterator
nonstd::ring_span<T, Popper>::crbegin() const noexcept {
  return const_reverse_iterator(end());
}

template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::const_iterator
nonstd::ring_span<T, Popper>::cend() const noexcept {
  return end();
}

template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::reverse_iterator
nonstd::ring_span<T, Popper>::rend() noexcept {
  return reverse_iterator(begin());
}

template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::const_reverse_iterator
nonstd::ring_span<T, Popper>::rend() const noexcept {
  return const_reverse_iterator(begin());
}

template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::const_reverse_iterator
nonstd::ring_span<T, Popper>::crend() const noexcept {
  return const_reverse_iterator(begin());
}
...
template <typename T, class Popper>
template <bool b, typename>
void nonstd::ring_span<T, Popper>::push_back(T&& value) noexcept(
  std::is_nothrow_move_assignable<T>::value) {
...
template <typename T, class Popper> auto nonstd::ring_span<T, Popper>::pop_front() {
  assert(m_size != 0);
...
template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::reference
nonstd::ring_span<T, Popper>::at(size_type i) noexcept {
  return m_data[i % m_capacity];
}

template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::const_reference
nonstd::ring_span<T, Popper>::at(size_type i) const noexcept {
  return m_data[i % m_capacity];
}

template <typename T, class Popper>
typename nonstd::ring_span<T, Popper>::size_type
nonstd::ring_span<T, Popper>::back_idx() const noexcept {
  return (m_front_idx + m_size) % m_capacity;
}

template <typename T, class Popper> void nonstd::ring_span<T, Popper>::increase_size() noexcept {
...
template <typename Ring, bool is_const>
template <bool C>
bool nonstd::ring_iterator<Ring, is_const>::operator==(
  const nonstd::ring_iterator<Ring, C>& rhs) const noexcept {
...
template <typename Ring, bool is_const>
typename nonstd::ring_iterator<Ring, is_const>::reference
nonstd::ring_iterator<Ring, is_const>::operator*() const noexcept {
  return m_rv->at(m_idx);
}

template <typename Ring, bool is_const>
nonstd::ring_iterator<Ring, is_const>&
nonstd::ring_iterator<Ring, is_const>::operator++() noexcept {
  ++m_idx;
  return *this;
}
...
template <typename Ring, bool is_const>
nonstd::ring_iterator<Ring, is_const>
nonstd::ring_iterator<Ring, is_const>::operator++(int) noexcept {
  auto r(*this);
  ++*this;
  return r;
}
...
template <typename Ring, bool is_const>
nonstd::ring_iterator<Ring, is_const>&
nonstd::ring_iterator<Ring, is_const>::operator+=(std::ptrdiff_t i) noexcept {
  this->m_idx += i;
  return *this;
}
...
template <typename Ring, bool is_const>
template <bool C>
std::ptrdiff_t nonstd::ring_iterator<Ring, is_const>::operator-(
  const nonstd::ring_iterator<Ring, C>& rhs) const noexcept {
