...
namespace nonstd {
  ...
  namespace detail {
    ...
    constexpr inline auto invoke_(T B::*f, D&& d, Args&&... args) noexcept(
      noexcept((std::forward<D>(d).*f)(std::forward<Args>(args)...))) ->
      typename std::enable_if<
        std::is_function<T>::value && std::is_base_of<B, typename std::decay<D>::type>::value,
    ...
    constexpr inline auto invoke_(T B::*f, R&& r, Args&&... args) noexcept(
      noexcept((r.get().*f)(std::forward<Args>(args)...))) ->
      typename std::enable_if<
        std::is_function<T>::value && is_reference_wrapper<typename std::decay<R>::type>::value,
    ...
    constexpr inline auto invoke_(T B::*f, P&& p, Args&&... args) noexcept(
      noexcept(((*std::forward<P>(p)).*f)(std::forward<Args>(args)...))) ->
      typename std::enable_if<
        std::is_function<T>::value && !is_reference_wrapper<typename std::decay<P>::type>::value
    ...
    constexpr inline auto invoke_(Callable&& c, Args&&... args) noexcept(
  ...
  constexpr inline auto invoke(F&& f, Args&&... args) noexcept(
    noexcept(detail::invoke_(std::forward<F>(f), std::forward<Args>(args)...)))
  ...
  namespace detail {
    ...
    struct invoke_result<
      decltype(void(invoke(std::declval<F>(), std::declval<Args>()...))), F, Args...> {
  ...
  template <typename F, typename... Args> using result_of_t = typename result_of<F(Args...)>::type;
