...
namespace math {
  ...
  plane plane::operator*(float s) const { return plane(data * s); }
  ...
  bool plane::operator==(const plane& p) const { return data == p.data; }

  plane plane::operator-() const { return plane(-data); }
