...
namespace math {
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  template <typename T, qualifier Q = defaultp> class transform_t {
  public:
  ...
  template <typename T, qualifier Q> transform_t<T, Q> inverse(transform_t<T, Q> const& t) {
    const auto& m = t.get_matrix();
    return glm::inverse(m);
  }

  template <typename T, qualifier Q> transform_t<T, Q> transpose(transform_t<T, Q> const& t) {
    const auto& m = t.get_matrix();
  ...
  template <typename T, qualifier Q>
  inline void
  transform_t<T, Q>::set_rotation_euler(const typename transform_t::vec3_t& euler_angles) {
  ...
  template <typename T, qualifier Q>
  inline void transform_t<T, Q>::set_rotation(
    const typename transform_t::vec3_t& x, const typename transform_t::vec3_t& y,
  ...
  template <typename T, qualifier Q> inline void transform_t<T, Q>::rotate(T x, T y, T z) {
    rotate({ x, y, z });
  }
  ...
  template <typename T, qualifier Q> inline void transform_t<T, Q>::rotate_local(T x, T y, T z) {
    rotate_local({ x, y, z });
  }
  ...
  template <typename T, qualifier Q> inline void transform_t<T, Q>::scale(T x, T y, T z) {
    scale({ x, y, z });
  }
  ...
  template <typename T, qualifier Q> inline void transform_t<T, Q>::translate(T x, T y, T z) {
    translate({ x, y, z });
  }
  ...
  template <typename T, qualifier Q> inline void transform_t<T, Q>::translate_local(T x, T y, T z) {
  ...
  template <typename T, qualifier Q> inline const transform_t<T, Q>& transform_t<T, Q>::identity() {
  ...
  template <typename T, qualifier Q>
  inline transform_t<T, Q>::operator const typename transform_t<T, Q>::mat4_t::value_type *()
    const {
    return value_ptr(get_matrix());
  }

  template <typename T, qualifier Q> inline transform_t<T, Q>::operator const mat4_t*() const {
    return &get_matrix();
  }
