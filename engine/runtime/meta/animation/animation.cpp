...
namespace runtime {
  REFLECT(node_animation) {
    rttr::registration::class_<node_animation>("node_animation")
      .property_readonly("node_name", &node_animation::node_name)(
  ...
  REFLECT(animation) {
    rttr::registration::class_<animation>("animation")
      ...
      .property_readonly("duration", &animation::duration)(
        rttr::metadata("pretty_name", "Duration"))
      .property_readonly("channels", &animation::channels)(
        rttr::metadata("pretty_name", "Channels"));
  }
