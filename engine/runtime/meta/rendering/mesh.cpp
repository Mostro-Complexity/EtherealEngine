...
REFLECT(mesh::info) {
  rttr::registration::class_<mesh::info>("info")
    .property_readonly("vertices", &mesh::info::vertices)(
      rttr::metadata("pretty_name", "Vertices"), rttr::metadata("tooltip", "Vertices count."))
    ...
    .property_readonly("subsets", &mesh::info::subsets)(
      rttr::metadata("pretty_name", "Subsets"), rttr::metadata("tooltip", "Subsets count."));
}
...
SAVE(skin_bind_data) { try_save(ar, cereal::make_nvp("bones", obj.bones_)); }
SAVE_INSTANTIATE(skin_bind_data, cereal::oarchive_binary_t);

LOAD(skin_bind_data) { try_load(ar, cereal::make_nvp("bones", obj.bones_)); }
