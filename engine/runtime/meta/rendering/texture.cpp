...
namespace gfx {
  REFLECT(texture_info) {
    ...
    rttr::registration::class_<texture_info>("texture_info")
      ...
      .property_readonly("storageSize", &texture_info::storageSize)(
        rttr::metadata("pretty_name", "Storage Size(bytes)"))
      ...
      .property_readonly("bitsPerPixel", &texture_info::bitsPerPixel)(
        rttr::metadata("pretty_name", "Bits Per Pixel"))
      .property_readonly("cubeMap", &texture_info::cubeMap)(
