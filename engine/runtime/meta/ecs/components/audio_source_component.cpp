...
REFLECT(audio_source_component) {
  rttr::registration::class_<audio_source_component>("audio_source_component")(
    ...
    .property(
      "auto_play", &audio_source_component::get_autoplay, &audio_source_component::set_autoplay)(
    ...
    .property("pitch", &audio_source_component::get_pitch, &audio_source_component::set_pitch)(
      ...
      rttr::metadata(
        "tooltip", "A multiplier for the frequency (sample rate) of the source's buffer."),
    ...
    .property(
      ...
      rttr::metadata("pretty_name", "Volume Rolloff"),
      rttr::metadata("min", 0.0f),
