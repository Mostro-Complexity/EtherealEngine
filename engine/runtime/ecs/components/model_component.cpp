...
void model_component::set_casts_shadow(bool cast_shadow) {
  if (casts_shadow_ == cast_shadow) { return; }
...
void model_component::set_casts_reflection(bool casts_reflection) {
  if (casts_reflection_ == casts_reflection) { return; }
...
bool model_component::casts_shadow() const { return casts_shadow_; }

bool model_component::is_static() const { return static_; }

const model& model_component::get_model() const { return model_; }
...
bool model_component::casts_reflection() const { return casts_reflection_; }
