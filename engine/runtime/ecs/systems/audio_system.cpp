...
namespace runtime {
  ...
  audio_system::audio_system() { on_frame_update.connect(this, &audio_system::frame_update); }

  audio_system::~audio_system() { on_frame_update.disconnect(this, &audio_system::frame_update); }
}  // namespace runtime
