...
public:
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  inline projection_mode get_projection_mode() const { return projection_mode_; }
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  inline float get_near_clip() const { return near_clip_; }
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  inline float get_far_clip() const { return far_clip_; }
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  inline float get_ortho_size() const { return ortho_size_; }
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  inline void set_viewport_pos(const upoint32_t& viewportPos) { viewport_pos_ = viewportPos; }
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  const usize32_t& get_viewport_size() const { return viewport_size_; }
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  inline const upoint32_t& get_viewport_pos() const { return viewport_pos_; }
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  inline bool is_frustum_locked() const { return frustum_locked_; }
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  inline void lock_frustum(bool locked) { frustum_locked_ = locked; }
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  inline const math::transform& get_view() const { return view_; }
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  inline math::transform get_view_projection() const { return get_projection() * get_view(); }
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  inline const math::transform& get_last_view() const { return last_view_; }
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  inline const math::transform& get_last_projection() const { return last_projection_; }
  ...
  //-----------------------------------------------------------------------------
  void set_aa_data(
    const usize32_t& viewportSize, std::uint32_t currentSubpixelIndex,
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  inline const math::vec4& get_aa_data() const { return aa_data_; }
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  bool viewport_to_ray(
    const math::vec2& point, math::vec3& rayOriginOut, math::vec3& rayDirectionOut) const;
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  bool viewport_to_world(
    const math::vec2& point, const math::plane& plane, math::vec3& positionOut, bool clip) const;
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  bool viewport_to_major_axis(
    const math::vec2& point, const math::vec3& axisOrigin, math::vec3& positionOut,
  ...
  //-----------------------------------------------------------------------------
  bool viewport_to_major_axis(
    const math::vec2& point, const math::vec3& axisOrigin, const math::vec3& alignNormal,
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  math::vec3 estimate_pick_tolerance(
    float pixelTolerance, const math::vec3& referencePosition,
...
protected:
  ...
  /**
   * @brief The aspect ratio used to generate the correct horizontal degrees (perspective only)
   *
   */
