...
public:
  ...
  void compute_palette_fit(
    bone_index_map_t& input, std::int32_t& current_space, std::int32_t& common_base,
...
public:
  ...
  //-----------------------------------------------------------------------------
  bool prepare_mesh(
    const gfx::vertex_layout& vertex_format, void* vertices, std::uint32_t vertex_count,
  ...
  bool set_vertex_source(
    void* source, std::uint32_t vertex_count, const gfx::vertex_layout& source_format);
  ...
  //-----------------------------------------------------------------------------
  bool create_cone(
    const gfx::vertex_layout& format, float radius, float radiusTip, float height,
  ...
  //-----------------------------------------------------------------------------
  bool end_prepare(
    bool hardware_copy = true, bool weld = true, bool optimize = true, bool build_buffers = true);
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  inline const math::bbox& get_bounds() const { return bbox_; }
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  inline mesh_status get_status() const { return prepare_status_; }
  ...
  /// </summary>
  //-----------------------------------------------------------------------------
  inline std::size_t get_subset_count() const { return mesh_subsets_.size(); }
...
protected:
  ...
  struct face_influences {
    bone_palette::bone_index_map_t
      bones;  // List of unique bones that influence a given number of faces.
  };
  ...
  //-----------------------------------------------------------------------------
  bool
  weld_vertices(float tolerance = 0.000001f, std::vector<std::uint32_t>* vertexRemap = nullptr);
  ...
  static void build_optimized_index_buffer(
    const subset* subset, std::uint32_t* source_buffer_ptr, std::uint32_t* destination_buffer_ptr,
