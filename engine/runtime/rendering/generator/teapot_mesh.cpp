...
teapot_mesh_t::triangles_t::triangles_t(const teapot_mesh_t& mesh) noexcept
  : mesh_t{ &mesh }, index_{ 0 }, patch_mesh_{ std::make_shared<bezier_mesh_t<4, 4>>(
                                    teapotData[0], gml::ivec2{ mesh.segments_, mesh.segments_ }) },
    triangles_{ patch_mesh_->triangles() } {}

bool teapot_mesh_t::triangles_t::done() const noexcept { return index_ == 32; }
...
teapot_mesh_t::vertices_t::vertices_t(const teapot_mesh_t& mesh) noexcept
  : mesh_{ &mesh }, index_{ 0 }, patch_mesh_{ std::make_shared<bezier_mesh_t<4, 4>>(
                                   teapotData[0], gml::ivec2{ mesh.segments_, mesh.segments_ }) },
    vertices_{ patch_mesh_->vertices() } {}

bool teapot_mesh_t::vertices_t::done() const noexcept { return index_ == 32; }

mesh_vertex_t teapot_mesh_t::vertices_t::generate() const { return vertices_.generate(); }
...
teapot_mesh_t::teapot_mesh_t(int segments) noexcept
  : segments_{ segments }, patch_vertex_count_{
      count(bezier_mesh_t<4, 4>{ teapotData[0], { segments, segments } }.vertices())
    } {}
...
teapot_mesh_t::vertices_t teapot_mesh_t::vertices() const noexcept { return vertices_t{ *this }; }
