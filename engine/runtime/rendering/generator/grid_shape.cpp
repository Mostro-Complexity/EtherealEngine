...
grid_shape_t::grid_shape_t(
  const gml::dvec2& size, const gml::ivec2& segments, const gml::ivec2& subSegments) noexcept
  : mImpl{
      // Horizontal lines
...
grid_shape_t::edges_t grid_shape_t::edges() const noexcept { return mImpl.edges(); }

grid_shape_t::vertices_t grid_shape_t::vertices() const noexcept { return mImpl.vertices(); }
