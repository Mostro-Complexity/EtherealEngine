...
box_edge_t::box_edge_t(
  const gml::dvec2& position, double radius, double size, int slices, int segments)
  : translate_mesh_{ { radius, size, slices, segments, 0.0, gml::radians(90.0) },
                     gml::dvec3{ position, 0.0 } } {}

box_edges_t::box_edges_t(const gml::dvec3& size, double radius, int slices, int segments)
  : mirrorMesh_{ { { gml::dvec2{ size }, radius, size[2], slices, segments }, axis_t::Y },
                 axis_t::X } {}

box_corner_t::box_corner_t(const gml::dvec3& position, double radius, int slices)
  : translate_mesh_{ { gml::dvec3{ radius, 0.0, 0.0 },
...
rounded_box_mesh_t::rounded_box_mesh_t(
  double radius, const gml::dvec3& size, int slices, const gml::ivec3& segments)
  : merge_mesh_{ { { { size[1], size[2] }, { segments[1], segments[2] }, size[0] + radius },
                   axis_t::Z,
                   axis_t::X,
                   axis_t::Y },
