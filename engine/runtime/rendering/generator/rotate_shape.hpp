...
namespace generator {
  ...
  template <typename shape_t> class rotate_shape_t {
  private:
  ...
  public:
    ...
    edges_t edges() const noexcept { return transform_shape_.edges(); }
  ...
  template <typename shape_t> rotate_shape_t<shape_t> rotate_shape(shape_t shape, double angle) {
