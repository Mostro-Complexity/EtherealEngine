...
namespace generator {
  ...
  private:
    using impl_t = merge_mesh_t<
      cylinder_mesh_t, translate_mesh_t<sphere_mesh_t>, translate_mesh_t<sphere_mesh_t>>;
    impl_t merge_mesh_;
  ...
  public:
    ...
    capsule_mesh_t(
      double radius = 1.0, double size = 0.5, int slices = 32, int segments = 4, int rings = 8,
