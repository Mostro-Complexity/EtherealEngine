...
namespace generator {
  ...
  private:
    ...
    template <typename shape_t> class derived : public base {
    public:
      ...
      any_generator<edge_t> edges() const override { return shape_.edges(); }

      any_generator<shape_vertex_t> vertices() const override { return shape_.vertices(); }
