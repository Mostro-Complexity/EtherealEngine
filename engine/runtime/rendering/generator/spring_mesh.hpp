...
namespace generator {
  ...
  public:
    ...
    spring_mesh_t(
      double minor = 0.25, double major = 1.0, double size = 1.0, int slices = 8, int segments = 32,
    ...
    triangles_t triangles() const noexcept { return extrude_mesh_.triangles(); }

    using vertices_t = typename impl_t::vertices_t;

    vertices_t vertices() const noexcept { return extrude_mesh_.vertices(); }
  };
}  // namespace generator
