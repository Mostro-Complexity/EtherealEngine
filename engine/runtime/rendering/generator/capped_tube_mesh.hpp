...
namespace generator {
  ...
  namespace detail {
    ...
    public:
      tube_cap_t(
        double radius, double innerRadius, double distance, int slices, int rings, double start,
        double sweep);
  ...
  public:
    ...
    capped_tube_mesh_t(
      double radius = 1.0, double innerRadius = 0.75, double size = 1.0, int slices = 32,
      int segments = 8, int rings = 1, double start = 0.0, double sweep = gml::radians(360.0));
