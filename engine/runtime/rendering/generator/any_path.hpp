...
namespace generator {
  ...
  private:
    ...
    template <typename path_t> class derived : public base {
    public:
      ...
      any_generator<edge_t> edges() const override { return path_.edges(); }

      any_generator<path_vertex_t> vertices() const override { return path_.vertices(); }
