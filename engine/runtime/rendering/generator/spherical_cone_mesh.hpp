...
namespace generator {
  ...
  private:
    using impl_t = translate_mesh_t<
      merge_mesh_t<cone_mesh_t, axis_flip_mesh_t<translate_mesh_t<sphere_mesh_t>>>>;
  ...
  public:
    ...
    spherical_cone_mesh_t(
      double radius = 1.0, double size = 1.0, int slices = 32, int segments = 8, int rings = 4,
