...
namespace generator {
  ...
  namespace detail {
    ...
    public:
      ...
      triangles_t triangles() const noexcept { return translate_mesh_.triangles(); }

      using vertices_t = typename impl_t::vertices_t;

      vertices_t vertices() const noexcept { return translate_mesh_.vertices(); }
    };
    ...
    public:
      ...
      triangles_t triangles() const noexcept { return mirrorMesh_.triangles(); }

      using vertices_t = typename impl_t::vertices_t;

      vertices_t vertices() const noexcept { return mirrorMesh_.vertices(); }
    };
  ...
  private:
    using impl_t = merge_mesh_t<
      axis_swap_mesh_t<detail::box_faces_t>, uv_flip_mesh_t<axis_swap_mesh_t<detail::box_faces_t>>,
      detail::box_faces_t, axis_swap_mesh_t<detail::box_edges_t>,
      axis_swap_mesh_t<detail::box_edges_t>, detail::box_edges_t, detail::box_corners_t>;
    impl_t merge_mesh_;
  ...
  public:
    ...
    rounded_box_mesh_t(
      double radius = 0.25, const gml::dvec3& size = { 0.75, 0.75, 0.75 }, int slices = 4,
