...
bool parametric_path_t::edges_t::done() const noexcept { return i_ == path_->segments_; }
...
parametric_path_t::parametric_path_t(
  const std::function<path_vertex_t(double)>& eval, int segments) noexcept
  : eval_{ std::move(eval) }, segments_{ segments }, delta_{ 1.0 / segments } {}

parametric_path_t::edges_t parametric_path_t::edges() const noexcept { return edges_t{ *this }; }
