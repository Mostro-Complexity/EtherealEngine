...
namespace generator {
  ...
  template <int D0, int D1> class bezier_mesh_t {
  private:
  ...
  public:
    ...
    triangles_t triangles() const noexcept { return parametric_mesh_.triangles(); }

    using vertices_t = typename impl_t::vertices_t;

    vertices_t vertices() const noexcept { return parametric_mesh_.vertices(); }
  };
}  // namespace generator
