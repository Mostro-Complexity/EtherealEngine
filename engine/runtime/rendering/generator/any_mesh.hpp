...
namespace generator {
  ...
  private:
    ...
    template <typename mesh_t> class derived : public base {
    public:
      ...
      any_generator<triangle_t> triangles() const override { return mesh_.triangles(); }

      any_generator<mesh_vertex_t> vertices() const override { return mesh_.vertices(); }
