...
namespace generator {
  ...
  template <typename mesh_t> class flip_mesh_t {
  private:
  ...
  public:
    ...
    triangles_t triangles() const noexcept { return triangles_t{ this->transform_mesh_ }; }
  ...
  template <typename mesh_t> flip_mesh_t<mesh_t> flip_mesh(mesh_t mesh) {
