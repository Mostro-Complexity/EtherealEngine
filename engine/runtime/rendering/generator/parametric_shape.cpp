...
bool parametric_shape_t::edges_t::done() const noexcept { return i_ == shape_->segments_; }
...
parametric_shape_t::parametric_shape_t(
  const std::function<shape_vertex_t(double)>& eval, int segments) noexcept
  : eval_{ std::move(eval) }, segments_{ segments }, delta_{ 1.0 / segments } {}

parametric_shape_t::edges_t parametric_shape_t::edges() const noexcept { return edges_t{ *this }; }
