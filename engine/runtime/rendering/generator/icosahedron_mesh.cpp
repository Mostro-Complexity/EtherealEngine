...
icosahedron_mesh_t::triangles_t::triangles_t(const icosahedron_mesh_t& mesh)
  : mesh_{ &mesh }, i_{ 0 }, triangle_mesh_{ std::make_shared<triangle_mesh_t>(
...
icosahedron_mesh_t::icosahedron_mesh_t(double radius, int segments)
  : radius_{ radius }, segments_{ segments }, face_vertex_count_{ count(
                                                triangle_mesh_t{ 1.0, segments }.vertices()) } {}
