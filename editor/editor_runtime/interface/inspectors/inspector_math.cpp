...
bool inspector_transform::inspect(
  ...
  gui::EndColumns();
  if (gui::Button(
        "P", ImVec2(ImGui::GetFrameHeightWithSpacing(), ImGui::GetFrameHeightWithSpacing()))) {
  ...
  if (gui::Button(
        "R", ImVec2(ImGui::GetFrameHeightWithSpacing(), ImGui::GetFrameHeightWithSpacing()))) {
  ...
  if (gui::Button(
        "S", ImVec2(ImGui::GetFrameHeightWithSpacing(), ImGui::GetFrameHeightWithSpacing()))) {
