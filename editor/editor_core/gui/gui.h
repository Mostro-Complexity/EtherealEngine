...
namespace gui {
  ...
  bool ImageButton(
    ...
    const ImVec4& _tintCol = ImVec4(1.0f, 1.0f, 1.0f, 1.0f));
  bool ImageButtonEx(
    std::shared_ptr<void> texture, const ImVec2& size, const char* tooltip = nullptr,
    bool selected = false, bool enabled = true);

  void ImageWithAspect(
    texture_info info, const ImVec2& texture_size, const ImVec2& size,
  ...
  int ImageButtonWithAspectAndLabel(
    texture_info info, const ImVec2& texture_size, const ImVec2& size, const ImVec2& uv0,
    const ImVec2& uv1, bool selected, bool* edit_label, const char* label, char* buf,
    size_t buf_size, ImGuiInputTextFlags flags = 0);

  bool ImageButtonWithAspectAndTextDOWN(
    texture_info info, const std::string& name, const ImVec2& texture_size, const ImVec2& imageSize,
